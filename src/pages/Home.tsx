...
const Home = () => {
  ...
  const programAnimation = useScrollAnimation();
  const involvedAnimation = useScrollAnimation();
    ...
    <div className="min-h-screen bg-background page-transition">
      ...
      <section className="bg-secondary py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl md:text-3xl text-primary/80 mb-8 animate-fade-in">
            Connecting Future Healthcare Leaders
          </h2>
          <p className="text-lg md:text-xl text-primary/70 mb-12 max-w-4xl mx-auto animate-fade-in">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div 
            ...
            className={`text-center mb-16 scroll-animate ${missionAnimation.isVisible ? 'visible' : ''}`}
          >
          ...
          <Card className={`section-card max-w-4xl mx-auto scroll-animate ${missionAnimation.isVisible ? 'visible' : ''}`}>
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <div 
            ref={programAnimation.ref}
            className={`text-center mb-16 scroll-animate ${programAnimation.isVisible ? 'visible' : ''}`}
          >
          ...
          <div className={`grid md:grid-cols-3 gap-8 scroll-animate ${programAnimation.isVisible ? 'visible' : ''}`}>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <div 
            ref={involvedAnimation.ref}
            className={`scroll-animate ${involvedAnimation.isVisible ? 'visible' : ''}`}
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              <Card className="section-card hover:shadow-lg transition-shadow duration-300">
